...
``` text
block        → new line, width/height work
inline       → stays in line
inline-block → stays in line + width/height work
```
...
sticky   → normal until scroll threshold
```
...
The main thing I learned from HTML and CSS is that I should not start by
memorizing every property. I should first understand the structure of
the page and then choose the CSS tool that fits the problem.
...
For me, knowing **why** I am using a property is more useful than just
memorizing the property.
