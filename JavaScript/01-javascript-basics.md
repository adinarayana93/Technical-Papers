...
These are my basic JavaScript notes for the MountBlue review.

The main goal is to understand:
- what type of value I am working with
- how JavaScript treats that value
- what `null` and `undefined` mean
- what truthy and falsy mean
- what `==` and `===` do
- what a function returns when I don't use `return`
...
when you specifically need to check for undefined.
...
# 12. MountBlue Review Questions

Try answering these without looking at the notes:

1. What are the different data types in JavaScript?
2. What are primitive values?
3. What are reference/object values?
4. What does `typeof` do?
5. What does `typeof null` return?
6. How do you check whether a value is an array?
7. What is the difference between `null` and `undefined`?
8. What are truthy and falsy values?
9. What are the falsy values in JavaScript?
10. Is `"0"` truthy or falsy?
11. Is `[]` truthy or falsy?
12. What is the difference between `==` and `===`?
13. Why is `===` generally preferred?
14. Why is `value === undefined` better than `!value` when specifically checking for `undefined`?
15. What does a function return if it has no `return` statement?
16. What is the difference between `console.log()` and `return`?
